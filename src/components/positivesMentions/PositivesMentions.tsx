...
import { PositivesMentionsContainer, Title, Candidate } from "./styles";
...
import { checkIfArrayContainsElement } from '../../utils/arrayUtils.ts';
import {
  mediaTypes,
  candidates,
} from "../../data/mediumTrendsData.tsx";
  ...
  return (
    <>
        <Title className="dashboard-title">
            MEDIOS DE RELEVANCIA QUE GENERARON MENCIONES <span className="dashboard-title-span">POSITIVAS</span>
        </Title>
        <PositivesMentionsContainer className="positive-mentions-container">
          ...
          <div key={index} className="candidate-wrapper">
            ...
            <Candidate className="mention">
                <p className="p-border">
                    MEDIOS POSITIVOS HACIA <span className={`${candidate.key}-span`}> {candidate.name} </span>
                </p>
      ...
      </PositivesMentionsContainer>
    </>
  );
};

export default PositivesMentions;
